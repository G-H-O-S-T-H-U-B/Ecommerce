<%@ Page Title="" Language="C#" MasterPageFile="~/user/mst.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="Ecommerce.user.shop" %>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-6"> <!-- col-xl-4 col-lg-4 col-md-6 col-sm-6 -->
