<%@ Page Title="" Language="C#" MasterPageFile="~/user/mst.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Ecommerce.user._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                            <div class="hero__caption">
                                ...
                                <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                    <a href="products.aspx" class="btn hero-btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                            <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                ...
                                <img src="../1890237.jpg" alt="" class=" heartbeat">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="room-btn pt-70">
                    <a href="products.aspx" class="btn view-btn1">View More Products</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="video-area mb-100 d-none">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="video-wrap">
                        <div class="play-btn "><a class="popup-video" href="https://www.youtube.com/watch?v=KMc6DyEJp04"><i class="align-self-center fas fa-play"></i></a></div>
                    </div>
                </div>
            </div>
            <!-- Arrow -->
